...
#[derive(Debug)]
pub struct MirthStateProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MirthStateProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MirthState processing");
    
    let mut processor = MirthStateProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MirthStateProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MirthStateProcessor::new(false);
